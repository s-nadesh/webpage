...
//    $dbconnect->sql = 'SELECT * FROM TESTHEADER WHERE  USERID IS NULL OR ROOT_CAUSE IS NULL OR EXPLAINATION IS NULL AND OVERALLSTATUS NOT LIKE "PASS%"';    
$dbconnect->sql = "SELECT * FROM TESTHEADER WHERE  (USERID IS NULL OR USERID='') OR (ROOT_CAUSE IS NULL OR ROOT_CAUSE='') OR (EXPLAINATION IS NULL OR EXPLAINATION='') AND OVERALLSTATUS NOT LIKE 'PASS%'";
$dbconnect->selecttb();
